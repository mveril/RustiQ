...
//! $$
//!
//! UHF uses separate $\alpha$ and $\beta$ densities. For spin $s$, its Fock matrix
//! has Coulomb contributions from $P^\alpha + P^\beta$ and exchange contributions
//! only from $P^s$. Iterations solve the Roothaan--Hall equation
